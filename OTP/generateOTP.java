...
public class generateOTP
{
	...
	generateOTP firstRun = new generateOTP();
 	String hashTest = firstRun.genHash(IV);
	firstRun.genPassword(hashTest); 
}
	public String genHash(String IV)throws Exception {
	...
	//now we need to generate numbers based on the SHA hash output. so take last 12 chars of sb string, 		convert in pairs to integer values
